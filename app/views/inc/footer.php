...
<script src="<?php echo URLROOT; ?>/vendor/jquery/jquery-3.2.1.min.js"></script>
<script src="<?php echo URLROOT; ?>/vendor/bootstrap/js/popper.js"></script>
...
<script src="<?php echo URLROOT; ?>/vendor/tilt/tilt.jquery.min.js"></script>
<script >
	$('.js-tilt').tilt({
		scale: 1.1
	})
